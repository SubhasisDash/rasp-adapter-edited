...
public class WorkshopDataNodePI extends PDataNode
{
	...
	private GroveTemperatureAndHumiditySensor humidNode;
	...
	public WorkshopDataNodePI(UUID machineAdapterId, String name,String nodeType,int nodePin) {
		...
		try {
			...
			case "Humidity": //$NON-NLS-1$
				this.humidNode = new GroveTemperatureAndHumiditySensor(pi, nodePin, GroveTemperatureAndHumiditySensor.Type.DHT11);
				break;
	...
	public GroveTemperatureAndHumiditySensor getHumidNode() {
		return humidNode;
	}

	public void setHumidNode(GroveTemperatureAndHumiditySensor humidNode) {
		this.humidNode = humidNode;
	}
